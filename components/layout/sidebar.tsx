...
export function Sidebar({ user, collapsed = false }: SidebarProps) {
  ...
  return (
    <TooltipProvider delayDuration={200}>
      ...
      >
        {/* Logo */}
        <div className="flex h-20 items-center justify-center border-b border-gray-100 px-3">
          <Image
            src="/logo-umara.png"
            ...
            <Tooltip>
              <TooltipTrigger asChild>
                <Link
                  ...
                  className="flex items-center justify-center rounded-lg py-2 transition-colors hover:bg-gray-50"
                >
              ...
              <TooltipContent side="right">
                ...
                <p className="text-xs opacity-80">{user.role.name}</p>
              </TooltipContent>
            </Tooltip>
          ) : (
            <Link
